...
export class bags extends React.Component {
   constructor(props) {
      super(props);
   ...
   // componentDidMount() {
   //     fetch(fetchLink + "GetProductOptions/4")
   //         .then(data => {
   //             console.log(data);
   //             this.setState({ productOptions: data.json });
   //         });
   // }
         ...
         },
         {
            ...
            content: [
               ...
               },
               {
                  ...
                  Text: "бордовый",
                  imgUrl:
                     "/products/Кофры/Материал/Квадрат прямой/бордовый.png",
               },
               {
                  id: 3,
                  category: "base",
                  ...
                  Text: "коричневый",
                  imgUrl:
                     "/products/Кофры/Материал/Квадрат прямой/коричневый.png",
               },
               {
                  id: 4,
                  category: "base",
               ...
               },
               {
                  ...
                  Text: "оранжевый",
                  imgUrl:
                     "/products/Кофры/Материал/Квадрат прямой/оранжевый.png",
               },
               {
                  id: 9,
                  category: "base",
